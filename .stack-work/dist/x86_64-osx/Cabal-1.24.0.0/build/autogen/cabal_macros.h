...
/* package practice-haskell-0.2.0.0 */
#define VERSION_practice_haskell "0.2.0.0"
#define MIN_VERSION_practice_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
...
/* package compile-time-player-0.2.0.0 */
#define VERSION_compile_time_player "0.2.0.0"
#define MIN_VERSION_compile_time_player(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "practice-haskell-0.2.0.0"

#define CURRENT_PACKAGE_KEY "practice-haskell-0.2.0.0"
